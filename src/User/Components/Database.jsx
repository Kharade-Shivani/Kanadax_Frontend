  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      >
        ...
        {/* Animated floating database elements */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-blue-500/10 rounded-full animate-float blur-3xl"></div>
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-green-500/10 rounded-full animate-float blur-3xl" style={{animationDelay: '2s'}}></div>
          ...
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center animate-on-scroll ${isVisible.hero ? 'visible' : ''}`}>
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative group">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-tr from-blue-600/20 to-transparent rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              </div>
            </div>
          </div>
          ...
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-6 mt-20 animate-stagger ${isVisible.hero ? 'visible' : ''}`}>
            {databaseFeatures.map((feature, index) => (
              ...
              >
                ...
                <div className="text-red-400 mb-3 text-2xl animate-bounce">{feature.icon}</div>
                ...
                >
                  ...
                  <div className="relative flex flex-col h-full">
                    ...
                    <div className={`flex flex-col items-center justify-center flex-1 ${activeService === index ? '' : 'h-full'
                      ...
                      {/* Icon */}
                      <div className={`text-red-600 transition-all duration-300 ${activeService === index ? 'scale-110 mb-3 animate-bounce' : 'scale-100 mb-4'
                        }`}>
                        {service.icon}
                      </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          ...
          <div className="mb-8">
            <div className={`flex flex-wrap gap-4 justify-center mb-8 animate-stagger ${isVisible['tech-stack'] ? 'visible' : ''}`}>
              {['relational', 'nosql', 'cloud'].map((tab) => (
                <button
                  key={tab}
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
            {databaseProjects.slice(0, 3).map((project, index) => (
              <div 
                key={project.id}
                className="bg-white rounded-2xl p-8 border border-gray-200 shadow-lg hover:shadow-xl hover:border-red-300 transition-all duration-500 hover-lift group relative overflow-hidden"
              >
      ...
      >
        <div className="absolute inset-0 z-0">
          <img
            ...
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-transparent via-white/60 to-white"></div>
        </div>
              ...
              >
                ...
                <div className="relative">
                  <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-red-200 group-hover:scale-110 transition-all duration-300">
                    <span className="text-2xl group-hover:scale-125 transition-transform animate-bounce">{item.icon}</span>
                  </div>
                  <h3 className="text-xl font-bold text-gray-900 mb-4 group-hover:text-red-600 transition-colors">
                    {item.title}
                  </h3>
